...
<div class="page-header">
  ...
  <div style="display:flex;gap:8px">
    <button class="btn btn-red" onclick="openModal('modal-add-dir')">+ Direction</button>
    <button class="btn btn-navy" onclick="openModal('modal-add-dom')">+ Domaine</button>
  </div>
</div>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><code class="mono"><?= h($d['abreviation'] ?? '—') ?></code></td>
            ...
            <td>
              <button class="btn btn-sm btn-ghost" onclick="openModal('modal-edit-dir-<?= $d['id'] ?>')">✏️</button>
              <a href="backoffice.php?toggle_dir=<?= $d['id'] ?>" class="btn btn-sm btn-ghost"><?= $d['actif'] ? '🔒' : '🔓' ?></a>
            </td>
          </tr>
          <?php endforeach ?>
        </tbody>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <button class="btn btn-sm btn-ghost" onclick="openModal('modal-edit-dom-<?= $d['id'] ?>')">✏️</button>
              <a href="backoffice.php?toggle_dom=<?= $d['id'] ?>" class="btn btn-sm btn-ghost"><?= $d['actif'] ? '🔒' : '🔓' ?></a>
            </td>
          </tr>
          <?php endforeach ?>
        </tbody>
...
<div class="modal-overlay" id="modal-add-dir">
  <div class="modal">
    <div class="modal-header">
      <h3 class="modal-title">Nouvelle direction</h3>
    ...
    <form method="POST" action="backoffice.php">
      ...
      <div class="modal-body">
        <div class="form-group">
          <label>Libellé *</label>
          <input type="text" name="libelle" required placeholder="Ex: Direction des Ressources Humaines">
        </div>
        <div class="form-group">
          <label>Abréviation</label>
          <input type="text" name="abreviation" placeholder="Ex: DRH" maxlength="10">
        </div>
      </div>
...
<div class="modal-overlay" id="modal-add-dom">
  <div class="modal">
    <div class="modal-header">
      <h3 class="modal-title">Nouveau domaine</h3>
    ...
    <form method="POST" action="backoffice.php">
      ...
      <div class="modal-body">
        <div class="form-group">
          <label>Libellé *</label>
          <input type="text" name="libelle_dom" required placeholder="Ex: Informatique">
        </div>
      </div>
      <div class="modal-footer">
...
<div class="modal-overlay" id="modal-edit-dir-<?= $d['id'] ?>">
  <div class="modal">
    <div class="modal-header">
      <h3 class="modal-title">Modifier — <?= h($d['libelle']) ?></h3>
    ...
    <form method="POST" action="backoffice.php">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <label>Abréviation</label>
          <input type="text" name="abreviation" value="<?= h($d['abreviation'] ?? '') ?>" maxlength="10">
        </div>
      </div>
      <div class="modal-footer">
