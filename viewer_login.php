...
.login-card{background:#1c1d1f;border:1px solid #2d2f31;border-radius:14px;
  padding:40px 36px;width:100%;max-width:420px;box-shadow:0 24px 64px rgba(0,0,0,.5);}
...
<div class="page">
  <div class="login-card">
    <?php if ($step === 'login'): ?>
      ...
      <div class="step-indicator"><div class="step done"></div><div class="step"></div></div>
      <?php if ($error): ?>
        <div class="alert-err"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg><?php echo htmlspecialchars($error); ?></div>
      <?php endif; ?>
      <form method="post">
        ...
        <div class="form-group">
          ...
          <div class="input-wrap">
            ...
            <input type="text" id="windows_login" name="windows_login" placeholder="prénom.nom ou matricule" autofocus required>
          </div>
    ...
    <?php else: ?>
      ...
      <p class="subtitle">Identifiant : <strong style="color:#e8eaf0"><?php echo htmlspecialchars($preLogin); ?></strong><br>Renseignez votre direction et service pour accéder aux formations.</p>
      <div class="step-indicator"><div class="step done"></div><div class="step done"></div></div>
      <?php if ($error): ?>
        <div class="alert-err"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg><?php echo htmlspecialchars($error); ?></div>
      <?php endif; ?>
      <form method="post">
        ...
        <div class="form-group">
          ...
          <div class="input-wrap">
            ...
            <input type="text" id="direction" name="direction" placeholder="Ex : DRH, DOSI, Direction Commerciale…" required>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="input-wrap">
            ...
            <input type="text" id="service" name="service" placeholder="Ex : Service Formation, Agence Centre…" required>
          </div>
        </div>
        <button type="submit" class="btn-submit">Accéder aux formations →</button>
      </form>
    <?php endif; ?>
    <p class="login-hint">Cet accès est réservé aux collaborateurs MUCODEC.<br><strong>Problème de connexion ?</strong> Contactez le Service Formation.</p>
  </div>
</div>
</body>
</html>
