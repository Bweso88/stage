...
<div class="page">
  ...
  <div class="left-panel">
    <div class="left-inner">
      ...
      <div class="features">
        <div class="feature"><div class="feature-icon">📤</div><div class="feature-text"><strong>Upload de vidéos</strong><span>Ajoutez vos tutoriels MP4 par thème</span></div></div>
        <div class="feature"><div class="feature-icon">📁</div><div class="feature-text"><strong>Gestion des thèmes</strong><span>Créez, renommez ou supprimez des catégories</span></div></div>
        <div class="feature"><div class="feature-icon">👤</div><div class="feature-text"><strong>Utilisateurs</strong><span>Gérez les accès et les rôles</span></div></div>
        <div class="feature"><div class="feature-icon">📊</div><div class="feature-text"><strong>Statistiques</strong><span>Suivez les vues et l'activité</span></div></div>
      </div>
    </div>
  </div>
  ...
  <div class="right-panel">
    <div class="login-box">
      ...
      <form method="post" autocomplete="off">
        <div class="form-group">
          ...
          <div class="input-wrap">
            ...
            <input type="text" id="username" name="username" value="<?php echo htmlspecialchars($username); ?>" placeholder="Votre identifiant" autofocus required>
          </div>
        </div>
        <div class="form-group">
      ...
      <hr class="divider">
      <p class="login-footer">Mot de passe oublié ? <a href="../setup.php">Réinitialiser via setup.php</a></p>
    </div>
  </div>
...
function togglePass(){
  ...
  if(inp.type==='password'){inp.type='text';icon.innerHTML='<path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"/><line x1="1" y1="1" x2="23" y2="23"/>';}
