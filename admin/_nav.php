...
.adm-top-right{flex:1;display:flex;align-items:center;justify-content:flex-end;gap:12px;padding-left:20px;}
.adm-user{display:flex;align-items:center;gap:9px;padding:6px 12px;border:1px solid var(--border);border-radius:8px;cursor:default;}
.adm-avatar{width:28px;height:28px;border-radius:50%;background:var(--indigo-l);border:1px solid var(--indigo);display:flex;align-items:center;justify-content:center;font-weight:800;font-size:.78rem;color:var(--indigo);flex-shrink:0;}
.adm-user-name{font-size:.83rem;font-weight:600;color:var(--text);}
.adm-user-role{font-size:.68rem;font-weight:700;text-transform:uppercase;letter-spacing:.04em;padding:1px 7px;border-radius:10px;background:var(--indigo-l);color:var(--indigo);}
.adm-theme-btn{width:32px;height:32px;border-radius:7px;background:transparent;border:1px solid var(--border);cursor:pointer;color:var(--muted);display:flex;align-items:center;justify-content:center;transition:all .2s;}
.adm-theme-btn:hover{background:var(--surface2);color:var(--text);}
.adm-logout{padding:6px 14px;border-radius:7px;border:1px solid var(--border);font-size:.82rem;font-weight:600;color:var(--muted);background:transparent;cursor:pointer;transition:all .2s;}
.adm-logout:hover{border-color:var(--red);color:var(--red);background:rgba(239,68,68,.06);}
.adm-sidebar{position:fixed;top:var(--top);left:0;bottom:0;width:var(--sb);z-index:100;background:var(--surface);border-right:1px solid var(--border);padding:16px 10px;overflow-y:auto;display:flex;flex-direction:column;gap:4px;}
.adm-sb-label{font-size:.68rem;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:var(--subtle);padding:14px 10px 6px;margin-top:4px;}
.adm-sb-link{display:flex;align-items:center;gap:10px;padding:9px 12px;border-radius:8px;color:var(--muted);font-size:.855rem;font-weight:500;transition:all .15s;position:relative;}
...
.adm-sb-link.on{background:var(--indigo-l);color:var(--indigo);font-weight:700;box-shadow:inset 3px 0 0 var(--indigo);}
.adm-sb-div{height:1px;background:var(--border);margin:10px 4px;}
.adm-sb-ext{display:flex;align-items:center;gap:10px;padding:9px 12px;border-radius:8px;color:var(--muted);font-size:.83rem;font-weight:500;transition:all .15s;margin-top:auto;}
...
.adm-main{margin-left:var(--sb);margin-top:var(--top);padding:28px 32px;min-height:calc(100vh - var(--top));flex:1;}
.adm-title{font-size:1.3rem;font-weight:800;color:var(--text);margin-bottom:24px;}
.card{background:var(--surface);border:1px solid var(--border);border-radius:var(--r);}
.card-hover{transition:transform .2s,box-shadow .2s,border-color .2s;}
.card-hover:hover{transform:translateY(-3px);box-shadow:0 12px 32px rgba(0,0,0,.3);border-color:var(--indigo);}
...
.btn{display:inline-flex;align-items:center;justify-content:center;gap:6px;padding:8px 18px;border-radius:8px;font-size:.855rem;font-weight:700;cursor:pointer;border:none;transition:all .2s;white-space:nowrap;}
...
.alert{padding:12px 16px;border-radius:8px;font-size:.855rem;margin-bottom:20px;display:flex;align-items:flex-start;gap:10px;}
...
.field label{display:block;font-size:.78rem;font-weight:700;color:var(--muted);text-transform:uppercase;letter-spacing:.05em;margin-bottom:7px;}
.field input,.field select,.field textarea{width:100%;padding:10px 14px;background:var(--bg);border:1px solid var(--border);border-radius:8px;color:var(--text);font-size:.9rem;outline:none;transition:border-color .2s,box-shadow .2s;font-family:inherit;}
.field input:focus,.field select:focus{border-color:var(--indigo);box-shadow:0 0 0 3px rgba(26,46,110,.15);}
.adm-table{width:100%;border-collapse:collapse;}
.adm-table th{padding:10px 16px;text-align:left;font-size:.72rem;font-weight:700;text-transform:uppercase;letter-spacing:.05em;color:var(--muted);border-bottom:1px solid var(--border);}
...
.modal-back{display:none;position:fixed;inset:0;background:rgba(0,0,0,.7);backdrop-filter:blur(4px);z-index:999;align-items:center;justify-content:center;}
...
<header class="adm-top">
  ...
  <div class="adm-top-right">
    <div class="adm-user">
      ...
      <div><div class="adm-user-name"><?php echo htmlspecialchars($me); ?></div></div>
